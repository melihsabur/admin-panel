...
import { Upload, File, Trash2, Brain, Download, FileText, Image, FileSpreadsheet } from 'lucide-react'
            ...
            {f.ai_analysis && (
              <div className="mt-3 p-3 bg-dark-900 rounded-lg border border-dark-700">
                ...
                <p className="text-xs text-dark-200">
                  {f.ai_analysis.summary || f.ai_analysis.message || JSON.stringify(f.ai_analysis).slice(0, 150)}
                </p>
